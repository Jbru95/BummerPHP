...
class PasswordValidateController
{
    ...
    public function __construct(Site $site, array $post) {
        ...
        if($editUser === null) {
            // User does not exist!
            $this->redirect = "$root/password-validate.php?v=$validator&e=".PasswordValidateView::EMAIL_IS_NOT_FOR_A_VALID_USER;
            return;
        }
        ...
        if($password1 !== $password2) {
            ...
            $this->redirect = "$root/password-validate.php?v=$validator&e=".PasswordValidateView::PASSWORD_DID_NOT_MATCH;
            return;
        }
